    ...
    return (
      <div id={styles.reg}>
        <div className={styles.reg}>
          <span className={styles.span1}>51wan</span>
          <span></span>
          <span
            className={styles.span2}
            onClick={this.goProduct.bind(this)}
          ></span>
        </div>
        <Tabs
          tabs={tabs}
        ...
        >
          ...
          >
            ...
            <div className={styles.remens}>
              <img
                src="http://m.51wan.com/ui/8/5c203d139d06b.png"
                alt=""
                className={styles.remenimg}
              ></img>
              <h3 className={styles.h1}>《COK》冬日双旦礼包</h3>
              <h3 className={styles.h2}>《COK》冬日双旦礼包</h3>
              <a
                className={styles.a1}
                href="http://m.51wan.com/gift/50.html?v=4153"
              >
                领取
              </a>
